...
<div id="contPar" class="contPar">
	<div id="page1"  style="z-index:1;">
		<div class="title0">QQ阅读平台</div>
		<div class="title1">海量小说、没广告、免费、有福利</div>
		<div class="imgGroug">
			<ul>
...
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
		<form action="">
			<h2>登录</h2><p class="tyg-p">欢迎访问  QQ阅读</p>
			...
			<button type="button" id="btn">登<span style="width:20px;"></span>录</button>
			{{--<input type="button"  style="width:20px;" id="btn" value="登录">--}}
		</form>
	</div>
</div>

More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
<script type="text/javascript" src="/index/js/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="/index/js/com.js"></script>
<!--[if IE 6]>
...
<script>
	$(function(){
	    $(document).on('click','#btn',function(){
	        ...
	        var pwd = $('#pwd').val();
			$.ajax({
				url:'http://www.novel.com/index/logins',
				type:'post',
				dataType:'json',
			});
