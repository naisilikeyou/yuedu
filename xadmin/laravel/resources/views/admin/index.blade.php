            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('小说首页','/admin/nindex')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>小说首页</cite></a>
                            </li>
                        </ul>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('添加小说','/admin/addnovel')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加小说</cite></a>
                            </li>
                        </ul>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('查看小说','city.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>查看小说</cite></a>
                            </li>
                        </ul>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('上传图片','/admin/indexpicture')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>上传图片</cite></a>
                            </li>
                        </ul>
